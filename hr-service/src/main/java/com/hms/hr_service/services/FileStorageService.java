...
public class FileStorageService {
    ...
    @Value("${minio.bucket:employee-images}")
     ...
     * @param employeeId The employee ID (used as prefix)
    ...
    public String uploadProfileImage(MultipartFile file, String employeeId) {
        ...
        String objectName = "profiles/" + employeeId + "/" + UUID.randomUUID() + extension;
        ...
        try (InputStream inputStream = file.getInputStream()) {
            ...
            log.info("Uploaded profile image: {} for employee: {}", objectName, employeeId);
