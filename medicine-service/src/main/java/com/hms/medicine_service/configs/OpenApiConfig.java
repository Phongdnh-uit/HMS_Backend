package com.hms.medicine_service.configs;
...
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI medicineServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Medicine Service API")
                        .version("1.0.0")
                        .description("REST API for medicine inventory management and prescription catalog in HMS")
                        .contact(new Contact()
